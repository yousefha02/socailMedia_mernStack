            ...
            <Grid container spacing={2} sx={{height:"100vh"}}>
                <Grid item xs={12} md={6}>
                    <Container sx={{display:"flex",flexDirection:"column",justifyContent:"center",height:"100%"}}>
                        <Typography sx={{textTransform:"uppercase",color:"#0082f4",
                        fontSize:"34px",marginBottom:"20px",fontWeight:"600",textAlign:"center"}}>Create New Account</Typography>
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            </Box>
                            {
                                load
                                ?
                                <Button variant="contained" sx={{opacity:0.7}}>Register...</Button>
                                :
                                <Button variant="contained" type="submit">Register</Button>
                            }
                        </form>
                        <Typography sx={{fontSize:"14px",marginTop:"20px",color:"#747579"}}>
                            already have an account? <ReactLink to="/login">Login</ReactLink>
                        </Typography>
                    </Container>
                </Grid>
